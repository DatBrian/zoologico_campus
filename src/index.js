...
const app = new App([new AnimalesRoutes, new EmpleadosRoutes, new EventosRoutes, new JornadasRoutes, new PasesRoutes,
new RestauranteCafeteriasRoutes, new ServiciosRoutes]);
